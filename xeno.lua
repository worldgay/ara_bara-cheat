-- ================================================================
--  xeno.lua
--  Объединённый скрипт ara_bara hub для Xeno
--  Автор: ara_bara
--  Версия: 1.0.0
-- ================================================================
...
-- ================================================================
--  МОДУЛЬ: NightsInTheForest (сокращённая версия для Xeno)
-- ================================================================
...
local plugins = {
    ...
    [3260590327] = TowerDefenseSimulator,
    [142823291] = MurderMystery2,
    [2933628366] = AnimeFightingSimulator,
    [7326934954] = NightsInTheForest,
}
